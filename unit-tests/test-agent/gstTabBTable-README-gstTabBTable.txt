...
------------------------------------------------------------------------
  ...
  the gstTabBTable table.  The agent will start by looking for the right
  ...
  file defaults/table-gstTabBTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      gstTabBTable_allocate_data
      gstTabBTable_release_data
 ...
 Index(es) for the gstTabBTable table
  ------------------------------------------------------------
  The index(es) for the gstTabBTable table are:
...
************************************************************************
gstTabBTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the gstTabBTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: gstTabBTable_data_access.[c|h]
------------------------------------------------------------------------
  The gstTabBTable_data_access file contains the interface to your data in
  ...
  FUNC : gstTabBTable_indexes_set
  WHERE: gstTabBTable_data_access.c
...
File: gstTabBTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : gstTabBData_get



File: gstTabBTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the gstTabBTable table.

To watch the flow of the gstTabBTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        gstTabBTable
        verbose:gstTabBTable
        internal:gstTabBTable

e.g.
        snmpd -f -Le -DgstTabBTable,verbose:gstTabBTable,internal:gstTabBTable
...
/*---------------------------------------------------------------------
 * GUILE-SNMP-TEST-MIB::gstTabBEntry.gstTabBIndex
 * gstTabBIndex is subid 1 of gstTabBEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.3.1977.1.4.1.1
 * Description:
 ...
 */
/*---------------------------------------------------------------------
 * GUILE-SNMP-TEST-MIB::gstTabBEntry.gstTabBIndex2
 * gstTabBIndex2 is subid 2 of gstTabBEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.3.1977.1.4.1.2
 * Description:
