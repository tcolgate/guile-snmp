...
------------------------------------------------------------------------
  ...
  the gstTabATable table.  The agent will start by looking for the right
  ...
  file defaults/table-gstTabATable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      gstTabATable_allocate_data
      gstTabATable_release_data
 ...
 Index(es) for the gstTabATable table
  ------------------------------------------------------------
  The index(es) for the gstTabATable table are:
...
************************************************************************
gstTabATable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the gstTabATable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: gstTabATable_data_access.[c|h]
------------------------------------------------------------------------
  The gstTabATable_data_access file contains the interface to your data in
  ...
  FUNC : gstTabATable_indexes_set
  WHERE: gstTabATable_data_access.c
...
File: gstTabATable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : gstTabAData_get



File: gstTabATable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the gstTabATable table.

To watch the flow of the gstTabATable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        gstTabATable
        verbose:gstTabATable
        internal:gstTabATable

e.g.
        snmpd -f -Le -DgstTabATable,verbose:gstTabATable,internal:gstTabATable
...
/*---------------------------------------------------------------------
 * GUILE-SNMP-TEST-MIB::gstTabAEntry.gstTabAIndex
 * gstTabAIndex is subid 1 of gstTabAEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.3.1977.1.3.1.1
 * Description:
